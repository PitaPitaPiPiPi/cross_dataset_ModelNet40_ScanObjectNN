...
def process_one_off(off_path, out_dir, sample_surface_n, percentile):
...
def walk_and_process(modelnet_root, out_root, sample_surface_n, percentile, workers, chunk_size):
    logger = get_logger('build_modelnet')
    off_paths = []
...
if __name__ == '__main__':
    ...
    walk_and_process(args.modelnet_root, args.out_root, args.sample_surface_n, args.percentile, args.workers, args.chunk_size)
