...
def main(config_path, sessions_json, out_root):
    ...
    walk_and_process(cfg['modelnet']['root'], out_root, cfg['modelnet'].get('sample_surface_n',10000), cfg['common']['percentile_scale'], cfg['parallel']['workers'], cfg['parallel']['chunk_size'])
    ...
    for h5p in h5_list:
        ...
        process_h5_file(h5p, out_root, split, cfg['common']['percentile_scale'], cfg['parallel']['workers'], cfg['parallel']['chunk_size'])
