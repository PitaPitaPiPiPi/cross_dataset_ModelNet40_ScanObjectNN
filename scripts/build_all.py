#!/usr/bin/env python3
# python -m scripts.build_all --config configs/preprocessing.yaml --sessions configs/sessions.json --out outputs
import argparse
import os
import yaml
...
def main(config_path, sessions_json, out_root):
    ...
    logger.info('Start ScanObjectNN')
